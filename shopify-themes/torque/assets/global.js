...
(function () {
  ...
  var config = window.Torque || { strings: {}, routes: {} };
  ...
  var cartDrawer = {
    ...
    open: function () {
      ...
      dispatch('torque:cart-drawer:open');
    },
    close: function () {
    ...
    render: function (cart) {
      ...
      dispatch('torque:cart:updated', { cart: cart });
    },
  ...
  window.Torque = window.Torque || {};
  window.Torque.cartDrawer = cartDrawer;
  window.Torque.formatMoney = formatMoney;
})();
