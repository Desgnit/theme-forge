# Amberline — Football Club HTML Template
...
This edition ships in **black & amber** end to end — dark sections,
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Blackwick Rovers` across the HTML files for the name.
...
unless stated otherwise). Thanks for buying Amberline — up the Rovers.
