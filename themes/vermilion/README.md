# Vermilion — Football Club HTML Template
...
This edition ships in **scarlet & gold** end to end — dark sections,
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Redbrook Rovers` across the HTML files for the name.
...
unless stated otherwise). Thanks for buying Vermilion — up the Rovers.
