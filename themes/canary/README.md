# Canary — Football Club HTML Template
...
This edition ships in **canary yellow & slate** end to end — dark sections,
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Marshside Rovers` across the HTML files for the name.
...
unless stated otherwise). Thanks for buying Canary — up the Rovers.
