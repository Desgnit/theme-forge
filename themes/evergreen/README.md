# Evergreen — Football Club HTML Template
...
This edition ships in **forest green & gold** end to end — dark sections,
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Oakhurst Rovers` across the HTML files for the name.
...
unless stated otherwise). Thanks for buying Evergreen — up the Rovers.
