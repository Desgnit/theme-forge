# Candystripe — Football Club HTML Template
...
This edition ships in **red & white stripes** end to end — dark sections,
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Westport Rovers` across the HTML files for the name.
...
unless stated otherwise). Thanks for buying Candystripe — up the Rovers.
