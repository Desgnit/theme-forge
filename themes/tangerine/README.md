# Tangerine — Football Club HTML Template
...
This edition ships in **tangerine orange & black** end to end — dark sections,
...
:root {
  ...
  --tc-font-display: "Saira Condensed", ...;
  --tc-font-body: "Inter", ...;
}
```
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Seabrook Rovers` across the HTML files for the name.
