# Callout Skip Hire — Skip Hire / Local Trade HTML Template

A premium, responsive HTML + Tailwind CSS template for local trade
businesses, shipped here as the **skip hire** edition with a complete
demo company (Loadstar Skips, Doncaster). Five pages: Home, Services,
Recent jobs, About and a quote-request page — built around what wins
skip-hire work: straight all-in prices, punctual delivery, waste-carrier
credentials and a phone number everywhere.
...
Editing: find-and-replace **Loadstar Skips**, **01302 496 048** and
**loadstarskips.co.uk**; swap the photos in `assets/img/` for your own job
