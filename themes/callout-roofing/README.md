# Callout Roofing — Roofer / Local Trade HTML Template

A premium, responsive HTML + Tailwind CSS template for local trade
businesses, shipped here as the **roofer** edition with a complete
demo company (Ridgeline Roofing, Newcastle). Five pages: Home, Services,
Recent work, About and a quote-request page — built around what wins
local trade work: reviews, guarantees, photos of real jobs and a phone
number everywhere.
...
Editing: find-and-replace **Ridgeline Roofing**, **0191 496 0660** and
**ridgelineroofing.co.uk**; swap the photos in `assets/img/` for your own job
photos (keep width/height attributes); paste your real reviews over the
...
Licence per the marketplace you purchased from. Thanks for buying Callout Roofing.
