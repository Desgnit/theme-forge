# Midnight — Football Club HTML Template
...
This edition ships in **midnight navy & sky** end to end — dark sections,
...
:root {
  ...
  --tc-font-display: "Archivo Narrow", ...;
  --tc-font-body: "Inter", ...;
}
```
...
- **Club name / crest** — the crest is an inline SVG in the header and
  ...
  `Northgate Rovers` across the HTML files for the name.
...
unless stated otherwise). Thanks for buying Midnight — up the Rovers.
