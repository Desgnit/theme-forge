# Etsy listing — Skyline — Football Club HTML Template (sky blue & gold)

| Field | Value |
|---|---|
| Type | Digital download |
| Title (≤140 chars) | Skyline — Football Club HTML Template (sky blue & gold) — HTML + Tailwind, Instant Digital Download |
| Price | £29 |
| File to upload | https://github.com/Desgnit/theme-forge/releases/download/themes-latest/skyline-theme-v1.0.0.zip (under 20 MB — fits Etsy's limit) |
| Images | marketing/marketplaces/assets/etsy/skyline-main.png (first), then marketing/covers/skyline-cover.png |

## Description

INSTANT DIGITAL DOWNLOAD — no physical item will be shipped.

A complete football club website in sky blue & gold — fixtures, results, league table, squad profiles, match reports and academy trials, styled for your colours out of the box.

Your club's website shouldn't look like a corporate brochure with a ball
photo. Skyline is a complete club site in **sky blue & gold** — the demo club
(Easthaven Rovers, est. 1902) wears your end of the colour spectrum so you can picture
...
**Try the live demo before you buy:** https://desgnit.github.io/theme-forge/skyline/
...
football club, soccer website, sports club, fixtures, league table, sky blue football, non-league, html template, tailwind css, landing page, small business, digital download, website template
