# Etsy listing — Vermilion — Football Club HTML Template (scarlet & gold)

| Field | Value |
|---|---|
| Type | Digital download |
| Title (≤140 chars) | Vermilion — Football Club HTML Template (scarlet & gold) — HTML + Tailwind, Instant Digital Download |
| Price | £29 |
| File to upload | https://github.com/Desgnit/theme-forge/releases/download/themes-latest/vermilion-theme-v1.0.0.zip (under 20 MB — fits Etsy's limit) |
| Images | marketing/marketplaces/assets/etsy/vermilion-main.png (first), then marketing/covers/vermilion-cover.png |

## Description

INSTANT DIGITAL DOWNLOAD — no physical item will be shipped.

A complete football club website in scarlet & gold — fixtures, results, league table, squad profiles, match reports and academy trials, styled for your colours out of the box.

Your club's website shouldn't look like a corporate brochure with a ball
photo. Vermilion is a complete club site in **scarlet & gold** — the demo club
(Redbrook Rovers, est. 1911) wears your end of the colour spectrum so you can picture
...
**Try the live demo before you buy:** https://desgnit.github.io/theme-forge/vermilion/
...
football club, soccer website, sports club, fixtures, league table, scarlet football, non-league, html template, tailwind css, landing page, small business, digital download, website template
