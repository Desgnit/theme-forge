# Gumroad listing — Canary — Football Club HTML Template (yellow & slate)

| Field | Value |
|---|---|
| Product type | Digital product (single file) |
| Name | Canary — Football Club HTML Template (yellow & slate) |
| URL slug | /l/canary |
| Price | £29 |
| File to upload | https://github.com/Desgnit/theme-forge/releases/download/themes-latest/canary-theme-v1.0.0.zip |
| Cover image | marketing/covers/canary-cover.png + marketing/covers/football-family-sheet.png |

## Summary (one-liner)

A complete football club website in yellow & slate — fixtures, results, league table, squad profiles, match reports and academy trials, styled for your colours out of the box.

## Description

Your club's website shouldn't look like a corporate brochure with a ball
photo. Canary is a complete club site in **yellow & slate** — the demo club
(Marshside Rovers, est. 1926) wears your end of the colour spectrum so you can picture
...
**Live demo:** https://desgnit.github.io/theme-forge/canary/
...
html template, tailwind css, landing page, small business website, football club template, soccer website, sports club, fixtures, league table, yellow football, non-league
