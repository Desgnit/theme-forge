# Creative Market listing — Forgeline — Industrial & Trade Supplier HTML Template

| Field | Value |
|---|---|
| Category | Web Templates → HTML/CSS |
| Name | Forgeline — Industrial & Trade Supplier HTML Template |
| Price | £39 (list in USD equivalent) |
| File to upload | https://github.com/Desgnit/theme-forge/releases/download/themes-latest/forgeline-theme-v1.0.0.zip |
| Preview images | marketing/covers/forgeline-cover.png (first) |

## Excerpt (short description)

A premium website template that actually understands the trade — datasheets, photometry downloads, quote requests and next-day delivery messaging, not another generic "business theme".
...
**Live preview:** https://desgnit.github.io/theme-forge/forgeline/

## Tags

html template, tailwind css, landing page, small business website, industrial website, trade supplier, wholesale, manufacturing, b2b template
